    ...
    const adminHTML = `
      ...
      ">
        ...
        <div style="padding: 20px;">
          ...
          <!-- Badge Progress Override Section -->
          <div style="margin-top: 20px; padding-top: 20px; border-top: 1px solid #e5e7eb;">
            <h4 style="margin: 0 0 10px 0; color: #1f2937;">Badge Progress Override</h4>
            <input type="email" id="badge-override-email" placeholder="Member Email" style="
              width: 100%;
              padding: 8px;
              margin-bottom: 8px;
              border: 1px solid #d1d5db;
              border-radius: 4px;
            ">
            <select id="badge-override-id" style="
              width: 100%;
              padding: 8px;
              margin-bottom: 8px;
              border: 1px solid #d1d5db;
            ...
            ">
              ...
              <option value="gbm_regular">GBM Regular (3 GBMs)</option>
              <option value="first_event">First Steps (1 Event)</option>
              <option value="pd_champion">PD Champion (5 PD Events)</option>
              <option value="mentor_master">Mentor Master (3 Mentorship)</option>
              <option value="volunteer_hero">Volunteer Hero (2 Community Service)</option>
              <option value="convention_attendee">Convention Explorer (1 Convention)</option>
              <option value="friend_recruiter">Friend Recruiter (3 Friends)</option>
              <option value="consistent_contributor">Consistent Contributor (3 Categories)</option>
            </select>
            <input type="number" id="badge-override-progress" placeholder="Current Progress (e.g., 1 for 1/3)" style="
              width: 100%;
              padding: 8px;
              margin-bottom: 8px;
              border: 1px solid #d1d5db;
              border-radius: 4px;
            ">
            <input type="text" id="badge-override-reason" placeholder="Reason (optional)" style="
              width: 100%;
              padding: 8px;
              margin-bottom: 10px;
              border: 1px solid #d1d5db;
              border-radius: 4px;
            ">
            <button onclick="AdminPanel.applyBadgeOverride()" style="
              background: #8b5cf6;
              color: white;
              border: none;
              padding: 10px 15px;
              ...
              cursor: pointer;
              margin-right: 8px;
            ">Apply Badge Override</button>
            <button onclick="AdminPanel.removeBadgeOverride()" style="
              background: #ef4444;
              color: white;
              border: none;
              padding: 10px 15px;
