...
async function calculateMemberPoints(signInData) {
    ...
    for (const entry of signInData) {
        ...
        if (!memberStats[Object.keys(memberStats)[0]]) {
            ...
            console.log('[Demographics Debug] Sample values:', {
                Major: entry['Major'],
                'Major/Field of Study': entry['Major/Field of Study'],
                Year: entry['Year'],
                'Year in School': entry['Year in School'],
                'National Dues': entry['National Dues'],
                'Paid National Dues': entry['Paid National Dues']
            });
        }
