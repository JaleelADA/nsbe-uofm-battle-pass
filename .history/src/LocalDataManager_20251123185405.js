...
async function getLiveSheetData() {
    ...
    // Find a row with actual Major/Year data
    const rowWithData = data.values.find(row => row[5] && row[5].trim() !== '');
    if (rowWithData) {
        console.log('[CSV Debug] Row with Major/Year data:', rowWithData);
