...
// Load events from the Events folder (pre-GBM2 events)
    async function loadEventsFromFolder() {
        const eventFiles = [
            ...
            { file: 'Attendance Data - Mentorship Mixer.csv', name: 'Mentorship Mixer: Estimathon', type: 'Mentorship', date: '10/1/2025' },
            { file: 'Attendance Data - Bowling W_ Coinbase.csv', name: 'Bowling w/ Coinbase', type: 'Social', date: '10/8/2025' },
            { file: 'Attendance Data - Lunch & Learn.csv', name: 'Lunch & Learn Series #1', type: 'PD', date: '10/16/2025' }
        ];    const eventsData = [];
