        ...
        {activeFilter === 'academic' && (
          <StyledSection theme="red" className="p-4 sm:p-6" style={{
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3 sm:gap-4">
              ...
              <div className="p-3 sm:p-4 bg-red-900/50 border border-red-400">
                 <a href="https://docs.google.com/spreadsheets/d/1QgiEN9uvriVSFjM0cr66UQFiCq2w08Qfmijlx4yfs6Q/edit?gid=0#gid=0" target="_blank" className="block p-2 text-xs sm:text-sm text-sky-100 hover:text-sky-200 border border-sky-600 transition-colors rounded">
                   📖 Access Wisdom Doc
                  </a>
              </div>
            </div>
