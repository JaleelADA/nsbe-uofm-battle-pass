        ...
        {activeFilter === 'nsbe' && (
          <div className="space-y-8">
            <StyledSection theme="red" className="p-6">
              <h3 className="text-xl font-bold text-red-200 mb-4 text-center">🔥 NSBE MENTORING INITIATIVES</h3>
              
              {/* M-Zone Sessions */}
              <div className="mb-8">
                <h4 className="text-lg font-semibold text-red-300 mb-4">🎯 M-Zone Mentorship Sessions</h4>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="p-4 bg-red-900/30 border border-red-400 rounded">
                    <div className="text-yellow-300 font-bold mb-2">One-on-One Mentorship</div>
                    <div className="text-red-100 text-sm mb-3">
                      Get paired with experienced upperclassmen and alumni for personalized career guidance.
                    </div>
                    <a href="https://forms.gle/q41GQF7KB7sh31gm9" target="_blank" 
                  ...
                  <div className="p-4 bg-red-900/30 border border-red-400 rounded">
                    ...
                    <div className="text-red-100 text-sm mb-3">
                      Connect with fellow engineering students for study groups and career development.
                    </div>
